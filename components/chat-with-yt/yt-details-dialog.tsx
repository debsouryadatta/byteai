...
interface YtDetailsDialogProps {
  showSummary: boolean;
...
export function YtDetailsDialog({
  showSummary,
  setShowSummary,
  showNoteDialog,
  setShowNoteDialog,
      ...
      <Dialog open={showSummary} onOpenChange={setShowSummary}>
        <DialogContent className="max-w-4xl h-[90vh] md:h-[85vh] p-6">
          <DialogHeader className="space-y-2">
            <DialogTitle className="text-2xl">Video Summary</DialogTitle>
            <DialogDescription className="text-muted-foreground">
              A comprehensive summary of the video content and its key points.
            </DialogDescription>
          </DialogHeader>
